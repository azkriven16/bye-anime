...
export const LatestEpisodesSection = ({
  data,
  isError,
  isLoading,
  refetch,
  ...
  <div className="text-center py-20 px-4">
    <div className="max-w-md mx-auto">
      ...
      <p className="text-zinc-400 mb-8 leading-relaxed">
        We're having trouble loading the latest episodes. Please try again.
      </p>
      <button
        onClick={refetch}
...
const AnimeCard = ({ anime }: { anime: LatestEpisodeAnime }) => {
  ...
  const safeDuration = anime.duration || "Unknown";
  const safeType = anime.type || "Unknown";
    ...
    <div className="group cursor-pointer relative h-full">
      <div className="rounded-lg overflow-hidden shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-black/50 transform-gpu group-hover:scale-105 origin-center h-full flex flex-col">
        ...
        <div className="p-3 group-hover:p-4 transition-all duration-300 flex-grow flex flex-col">
          ...
          {/* Episode info with safe fallbacks */}
